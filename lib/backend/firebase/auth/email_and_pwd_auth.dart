...
// theese lines are use to connect app with firebase data base
...
class EmailAndPasswardAuth{
  ...
  Future<EmailSignInResult>signInWithEmailAndPassward({required String email, required String pwd})async{
    try{
      ...
      if(userCredential.user!.emailVerified)
        ...
        if(logOutResponse)
          return EmailSignInResult.EmailNotVerified;
        return EmailSignInResult.UnexpectedError;
      }

    }catch(e){
      print('Error in Sign In with Email And Passward Authentication: ${e.toString()}');
