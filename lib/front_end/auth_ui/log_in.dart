              ...
              child: Form(
                ...
                child: ListView(
                  children: [
                    ...
                    //commonTextFormField(hintText:'Confirm Passward'),
                    logInAuthButton(context,'LOG-IN'),
                    logInSocialMediaIntegrationButtons(),
                    SizedBox(height: 30.0,),
                    switchToAnotherPage(context, 'Dont have an account? ','Sign-up'),
      ...
      child: ElevatedButton(
        ...
        onPressed: () async {
          if(this._logInKey.currentState!.validate()){
            ...
            final EmailSignInResult emailSignInResult = await _emailAndPasswardAuth.signInWithEmailAndPassward(email: this._email.text, pwd: this._pwd.text);
            String msg ='';
            ...
            }else if(emailSignInResult == EmailSignInResult.EmailorPasswardInvalid)
